...
However, if the **treatment** and **control** groups have systematic differences other than the treatment, then it might be difficult to identify causality (counfounding).

Therefore, **randomized controlled experiments** are industry standard.
